...
class DocumentHandler:
    ...
    def __init__(self,data_dir=None,session_id=None):
        try:
            ...
            log.info("PDF handler Initialized" , session_id = self.session_id ,session_path = self.session_id_path)
        except Exception as e:
            log.error(f"erorr initalized DocumentHandler {e}")
    ...
    def save_pdf(self,pdf_data):
        try:
            ...
            log.info("PDF Save Succesfully" , path = save_path)
            return save_path
        except Exception as e:
            log.error(f"erorr initalized Save PDF {e}") 
